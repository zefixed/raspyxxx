...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(change_schedule_button, 3, 0, 1, 1);
        ...
        gridLayout->addLayout(week_Layout, 1, 0, 1, 2);
        ...
        gridLayout->addWidget(exceptions_button, 4, 0, 1, 1);
